                                      ...
                                      struct avl_tree *kvs_delta_stats)
{
    ...
    int64_t approx_doc_len = item->doc_size;
    ...
    if (item->action == WAL_ACT_INSERT ||
        ...
        if (old_offset == BLK_NOT_FOUND) {
            ...
            kvs_delta_stat->datasize += approx_doc_len;
            kvs_delta_stat->deltasize += approx_doc_len;
            ...
            delta = approx_doc_len - (int)_fdb_get_docsize(_doc.length);
